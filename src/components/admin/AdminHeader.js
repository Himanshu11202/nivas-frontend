      ...
      <div className="h-full px-4 lg:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:block">
            <h1 className="text-sm font-bold text-slate-800 tracking-tight">{societyName || 'Admin Dashboard'}</h1>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden sm:block text-left">
                <p className="text-[13px] font-bold text-slate-700 leading-tight">{user?.name || 'Admin'}</p>
                <p className="text-[11px] font-medium text-slate-400 mt-0.5">{user?.role || 'Administrator'}</p>
              </div>
